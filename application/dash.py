     ...
     dbc.Row(
           [
               dbc.Col(dbc.Button(([html.H5("2015", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/abusosexual/blob/main/application/static/Mapa%20asbusosexual%20Total2015.png?raw=true",
               ...
               dbc.Col(dbc.Button(([html.H5("2016", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/abusosexual/blob/main/application/static/Mapa%20asbusosexual%20Total2016.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2017", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/abusosexual/blob/main/application/static/Mapa%20asbusosexual%20Total2017.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2018", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/abusosexual/blob/main/application/static/Mapa%20asbusosexual%20Total2018.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2019", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/abusosexual/blob/main/application/static/Mapa%20asbusosexual%20Total2019.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
